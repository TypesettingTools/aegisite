...
weight: 4700
aliases:
  - /docs/3.5/Resolution_Resampler/
---

The Resolution Resampler is a built-in tool designed to change the [resolution of the script]({{< relref "Resolution_and_Matrix" >}}) while transforming all affected tags so it
